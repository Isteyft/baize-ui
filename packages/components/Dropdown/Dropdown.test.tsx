...
import { BaizeDropdown, BaizeDropdownItem } from ".";
...
describe("Dropdown/index.ts", () => {
  ...
  it("should be exported with withInstall()", () => {
    expect(BaizeDropdown.install).toBeDefined();
    expect(BaizeDropdownItem.install).toBeDefined();
  });

  // 测试 Dropdown 组件是否被正确导出
  it("should be exported Dropdown component", () => {
    expect(BaizeDropdown).toBe(Dropdown);
    expect(BaizeDropdownItem).toBe(DropdownItem);
  });

  // 可选：测试 withInstall 是否增强了 Tooltip 组件的功能
  test("should enhance Dropdown component", () => {
    const enhancedDropdown = withInstall(Dropdown);
    expect(enhancedDropdown).toBe(BaizeDropdown);
...
describe("Dropdown.vue", () => {
  ...
  it("should render slots correctly", () => {
    ...
    expect(wrapper.find(".baize-dropdown").exists()).toBeTruthy();
  });
  ...
  it("should emit command event when item is clicked", async () => {
    ...
    expect(wrapper.find(".baize-dropdown__menu").exists()).toBeTruthy();
  ...
  it("should toggle visibility when split btn is clicked", async () => {
    ...
    expect(wrapper.find(".baize-dropdown__menu").exists()).toBeFalsy();
