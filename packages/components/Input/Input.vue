...
import { useFocusController, useId  } from "@baize-ui/hooks";
...
<div
    class="baize-input"
    :class="{
      [`baize-input--${type}`]: type,
      [`baize-input--${size}`]: size,
    ...
    <template v-if="type !== 'textarea'">
      <div v-if="$slots.prepend" class="baize-input__prepend">
        <slot name="prepend"></slot>
      </div>
      <div class="baize-input__wrapper" ref="wrapperRef">
        <span v-if="$slots.prefix" class="baize-input__prefix">
          <slot name="prefix"></slot>
        </span>
        <input
          class="baize-input__inner"
          ref="inputRef"
          :id="useId().value"
