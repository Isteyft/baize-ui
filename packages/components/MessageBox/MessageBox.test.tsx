...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".baize-message-box__header");
    const title = document.querySelector(".baize-message-box__title");
    const message = document.querySelector(".baize-message-box__message");
  ...
  it("handles input in prompt mode", async () => {
    ...
    const confirmBtn = document.querySelector(
      ".baize-message-box__confirm-btn"
    ) as HTMLButtonElement;
    confirmBtn.click();
